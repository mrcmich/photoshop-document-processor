...
var azione = "SINISTRA";   // Variabile contenente il nome dell'azione che definisce le caratteristiche del testo sovrimpresso
...
filtroSovrimpressione = new FiltroSovrimpressione(
    ...
    new EstrattoreCodiceNumericoStandard(), 
